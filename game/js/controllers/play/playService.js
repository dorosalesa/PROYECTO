...
export class PlayService extends Service {
  ...
  getCards(difficulty, theme) {
    var cards = [];
    //var url = `http://us-central1-cenfoprojectsbackend.cloudfunctions.net/app/cards/${difficulty}/type/${theme}`;
    //var url = `http://localhost:3000/cards/${difficulty}/${theme}`;
    var url = `https://diana-memorygame.vercel.app/cards/${difficulty}/${theme}`;
